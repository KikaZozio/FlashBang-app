...
Le vérificateur ne fait aucune installation automatique (pour rester simple et sûr) : il ouvre juste le lien de téléchargement dans le navigateur, et tes amis installent la nouvelle version comme d'habitude (réinstaller par-dessus / remplacer le fichier). En cas de coupure internet ou si le dépôt n'est pas encore configuré, la vérification silencieuse au démarrage échoue sans rien afficher — l'app fonctionne normalement.
